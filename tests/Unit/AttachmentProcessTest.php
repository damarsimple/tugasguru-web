...
class AttachmentProcessTest extends TestCase
{
    ...
    {
        $mediaUrl =
            "https://upload.wikimedia.org/wikipedia/commons/5/57/ESA-Astronaut-Paolo-Nespoli_Voice-intro-ENG.flac";
